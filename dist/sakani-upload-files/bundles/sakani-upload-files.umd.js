(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/operators'), require('@angular/common/http'), require('rxjs'), require('spark-md5'), require('@angular/forms'), require('@angular/common'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('sakani-upload-files', ['exports', '@angular/core', 'rxjs/operators', '@angular/common/http', 'rxjs', 'spark-md5', '@angular/forms', '@angular/common', '@angular/platform-browser'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["sakani-upload-files"] = {}, global.ng.core, global.rxjs.operators, global.ng.common.http, global.rxjs, global.SparkMD5, global.ng.forms, global.ng.common, global.ng.platformBrowser));
})(this, (function (exports, i0, operators, i1, rxjs, SparkMD5, i1$2, i11, i1$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SakaniUploadFilesService = /** @class */ (function () {
        ...
        SakaniUploadFilesService.prototype.directUpload = function (_a) {
            var file = _a.file, apiUrl = _a.apiUrl, uploader = _a.uploader, headers = _a.headers;
        ...
        SakaniUploadFilesService.prototype.directUploadByActiveRecord = function (_a) {
            var file = _a.file, apiUrl = _a.apiUrl, folder = _a.folder, headers = _a.headers;
            var options = { headers: headers };
            var payload = {
                data: {
                    type: 'direct_uploads',
    ...
    var ModalService = /** @class */ (function () {
        function ModalService() {
            this.display = new rxjs.BehaviorSubject("close");
        }
        ModalService.prototype.watch = function () {
    ...
    ModalService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ModalService, deps: [], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    ModalService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ModalService, providedIn: "root" });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ModalService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: "root",
                    }]
    ...
    ModalComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ModalComponent, deps: [{ token: ModalService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ModalComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: ModalComponent, selector: "app-modal", inputs: { imgUrl: "imgUrl" }, ngImport: i0__namespace, template: "<ng-container *ngIf=\"display$ | async as display\">\n  <section\n    [class.open]=\"display === 'open'\"\n    (click)=\"close()\"\n    class=\"d-block modal fade show\"\n  >\n    <div\n      (click)=\"$event.stopPropagation()\"\n      class=\"modal-dialog modal-dialog-centered modal-xl\"\n    >\n      <div class=\"modal-content\">\n        <div class=\"modal-body text-center\">\n          <img class=\"img-fluid\" [src]=\"imgUrl\" />\n        </div>\n      </div>\n    </div>\n  </section>\n</ng-container>\n", styles: ["section{visibility:hidden;opacity:0;display:block;position:absolute;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,.2);transition:opacity .25s ease-in}section.open{visibility:inherit;opacity:1}\n"], directives: [{ type: i11__namespace.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }], pipes: { "async": i11__namespace.AsyncPipe } });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ModalComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: ModalService }]; }, propDecorators: { imgUrl: [{
                    type: i0.Input
                }] } });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: SakaniUploadFilesComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$2.NgControl }, { type: i1__namespace$2.FormBuilder }, { type: SakaniUploadFilesService }, { type: ModalService }]; }, propDecorators: { translateService: [{
                    type: i0.Input
                }], isActiveStorage: [{
                    type: i0.Input
                }], headers: [{
    ...
    SakaniMultipleUploadModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: SakaniMultipleUploadModule, declarations: [SakaniUploadFilesComponent, SafePipe, IconRemoveCircleComponent,
            ...
            IconLoadingComponent,
            IconFileComponent,
            ModalComponent], imports: [i11.CommonModule, i1$2.FormsModule, i1$2.ReactiveFormsModule], exports: [SakaniUploadFilesComponent, IconRemoveCircleComponent,
            IconErrorComponent,
            IconResetComponent,
            IconUploadPlusComponent,
            IconLoadingComponent,
            IconFileComponent,
            ModalComponent] });
    SakaniMultipleUploadModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: SakaniMultipleUploadModule, imports: [[i11.CommonModule, i1$2.FormsModule, i1$2.ReactiveFormsModule]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: SakaniMultipleUploadModule, decorators: [{
                ...
                args: [{
                        ...
                        imports: [i11.CommonModule, i1$2.FormsModule, i1$2.ReactiveFormsModule],
