...
import { Subject, BehaviorSubject, defer, combineLatest, of, forkJoin } from 'rxjs';
...
SakaniUploadFilesComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: SakaniUploadFilesComponent, deps: [{ token: i1$2.NgControl }, { token: i1$2.FormBuilder }, { token: SakaniUploadFilesService }, { token: ModalService }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: SakaniUploadFilesComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$2.NgControl }, { type: i1$2.FormBuilder }, { type: SakaniUploadFilesService }, { type: ModalService }]; }, propDecorators: { translateService: [{
                type: Input
            }], isActiveStorage: [{
                type: Input
            }], headers: [{
...
export { IconErrorComponent, IconFileComponent, IconLoadingComponent, IconRemoveCircleComponent, IconResetComponent, IconUploadPlusComponent, ModalComponent, SakaniMultipleUploadModule, SakaniUploadFilesComponent, SakaniUploadFilesService };
